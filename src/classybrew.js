        ...
        return function () {
            ...
            this.sizeSchemes = {
                ...
                default: {
                    3: [5, 7.5, 9.75],
                    4: [5, 7.5, 9.75, 12.675],
                    5: [5, 7.5, 9.75, 12.675, 16.4775],
                    6: [5, 7.5, 9.75, 12.675, 16.4775, 21.42075],
                    7: [5, 7.5, 9.75, 12.675, 16.4775, 21.42075, 27.846975],
                    8: [5, 7.5, 9.75, 12.675, 16.4775, 21.42075, 27.846975, 36.2010675],
                    9: [5, 7.5, 9.75, 12.675, 16.4775, 21.42075, 27.846975, 36.2010675, 47],
                    10: [5, 7.5, 9.75, 12.675, 16.4775, 21.42075, 27.846975, 36.2010675, 47, 60.1],
                    11: [5, 7.5, 9.75, 12.675, 16.4775, 21.42075, 27.846975, 36.2010675, 47, 60, 78]
                }
            };
            ...
            // get size for a given value
            this.getSizeInRange = function (num) {
                // return size value for supplied number
                // [4, 6, 8, 9]
                // [4-5.99, 6-7.99, 8-9]
                var i = 0;
                for (i; i < this.range.length; i++) {
                    if (num >= this.range[i] && this.range[i + 1]) {
                        if (num < this.range[i + 1]) {
                            return this.sizeSchemes['default'][this.numClasses][i];
                        }
                    } else if (num == this.range[i]) {
                        return this.sizeSchemes['default'][this.numClasses][i - 1];
                    } else {
                        return false;
                    }
                }
            ...
            // get size for a given value
            this.getZIndexInRange = function (num) {
                // return size value for supplied number
                // [4, 6, 8, 9]
                // [4-5.99, 6-7.99, 8-9]
                var i = 0;
                for (i; i < this.range.length; i++) {
                    if (num >= this.range[i] && this.range[i + 1]) {
                        if (num < this.range[i + 1]) {
                            return this.zIndexSchemes['default'][this.numClasses][i];
                        }
                    } else if (num == this.range[i]) {
                        return this.zIndexSchemes['default'][this.numClasses][i - 1];
                    } else {
                        return false;
                    }
                }
